...
List<UserDataRes> userDataResFromJson(String str) => List<UserDataRes>.from(
    json.decode(str).map((x) => UserDataRes.fromJson(x)));

String userDataResToJson(List<UserDataRes> data) =>
...
class UserDataRes {
  ...
  factory UserDataRes.fromJson(Map<String, dynamic> json) => UserDataRes(
        id: json["id"],
        uid: json["uid"],
